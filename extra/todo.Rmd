...
* Subset with logicals.  AFAIK there is no way to pass the type of the input to
  make this decision.  We would need to change the interface to add support.
  Major issue is result size, which is not knowable ex-ante.  Subassign would be
  okay since size isn't changed.  Do we allow at all?
