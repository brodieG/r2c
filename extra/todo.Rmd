...
* WTH is going on:
    ...
    microbenchmark::microbenchmark(sum_prod_loop(a, a), sum_prod_vec(a, a), times=10)
    Unit: milliseconds
                    expr       min       lq     mean    median        uq      max
     sum_prod_loop(a, a)  87.69433  90.4110 103.8416  93.97704  95.81529 203.3326
      sum_prod_vec(a, a) 140.93150 141.5957 156.6167 144.88217 145.41362 273.1965
     neval
        10
        10
