...
* How do we get the functions to keep their original parameter names given the
  renaming we do in normalization?  Part of the problem is we want to be able to 

* Need to move around the check for formals using reserved symbols given the
  desire to normalize symbols...
