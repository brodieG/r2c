...
We also tested just using directly `r2c_sum` as a test and that caused the same
error.  Generating the function in the test file proper doesn't cause any issues
at all.
