...
too?
    ...
    roll_exec(f, data, n, align, by, partial, MoreArgs, enclos)

    rollby_exec(
      f, data, width, shift, by, x, start, end, bounds, partial,
      MoreArgs, enclos
    )
    rollat_exec(
      f, data, width, shift, at, x, bounds, partial, MoreArgs, enclos
    )
    rollin_exec(
      f, data, width, shift, x, left, right, bounds, partial, MoreArgs, enclos
    )
