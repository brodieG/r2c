...
But the drawback is that then people that compile "r2c_fun" functions need to be
aware of the internals of the resulting function to avoid conflicts with their
symbols, which is a no go?

We should be able to fix the code to handle this:

    (<fun>)(<base::environemnt>(), <base::sys.call()>)
    (<base_eval>)(<base_bquote>)(group_exec_int(...))

Second is probably our own
