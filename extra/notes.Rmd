...
## Testing Irregular Windows

* Test against an R-level implementation?  Generate the sequence of points, and
  for each one, turn into a range, find the things in the range, and e.g. sum
  them?
* 
