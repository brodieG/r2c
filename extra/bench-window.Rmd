...
Test overhead:
    ...
    res.wi1 <- window_i_exec(
      r2c_sum, data=x, index=i, width=1, align=0, by=1
    )
    x <- 2^(0:2)
    window_i_exec(
      r2c_sum, data=x, index=seq_along(x), width=1, align=0, by=1
    )
    x <- 2^(0:2)
    window_i_exec(
      r2c_sum, data=x, index=seq_along(x), width=1, align=1, by=1
    )
    window_i_exec(
      r2c_sum, data=x, index=seq_along(x), width=1, align=.5, by=1
    )
    window_i_exec(
      r2c_sum, data=x, index=seq_along(x), width=2, align=1, by=1,
      partial=TRUE
    )
