...
including warm-up cycles and compatibility limitations[^3].  But it otherwise
pretty impressively turns what would be interpreted R code into something akin
